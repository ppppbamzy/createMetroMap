...
\begin{document}
\begin{tikzpicture}[every node/.append style={rounded corners, inner sep=2, font = \large}]
            
    \tikzset{pillbox/.style={text width = 1.5ex, anchor = center, draw, very thick, fill=white, align = center, font = \scriptsize, execute at begin node=\setlength{\baselineskip}{2ex}}};
...
%        \node[testlayout] at (l1s\num) {};
    ...
    \node[above = 0 of l1s4_num, xshift = -1ex, yshift = 0.5ex] (l1s4_name) {\Large 我駅};
