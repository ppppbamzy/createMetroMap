...
%            \draw[blue, very thick] (plc2) to [bend right = 45] (plc4);
            ...
            \draw[blue, very thick] (plc6) -- (below6);
            \coordinate [right = 0.1 of plc1_num] (right1);
            \draw[blue, very thick] (plc1) -- (right1);
            \draw[blue, very thick] (right1) to [bend right = 45] (below6);
            \coordinate [below = 0.1 of plc3_num] (below3);
            \draw[blue, very thick] (plc3) -- (below3);
            \coordinate [left = 0.1 of plc1_num] (left1);
            \draw[blue, very thick] (plc1) -- (left1);
            \draw[blue, very thick] (left1) to [bend left = 45] (below3);
            \coordinate [above = 0.1 of plc5_num] (above5);
            \draw[blue, very thick] (plc5) -- (above5);
            \coordinate [right = 0.1 of plc2_num] (right2);
            \draw[blue, very thick] (plc2) -- (right2);
            \draw[blue, very thick] (right2) to [bend left = 45] (above5);
            \coordinate [above = 0.1 of plc4_num] (above4);
            \draw[blue, very thick] (plc4) -- (above4);
            \coordinate [left = 0.1 of plc2_num] (left2);
            \draw[blue, very thick] (plc2) -- (left2);
            \draw[blue, very thick] (left2) to [bend right = 45] (above4);
            ...
            \node [right = 0 of plc1_num, yshift=-6] (plc1_word) {第四}; 
            \node [right = 0 of plc2_num, yshift=6] (plc2_word) {第七}; 
